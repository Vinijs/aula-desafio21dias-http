            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapPost("/body-data", async context => {
                    ...
                    using(StreamReader stream = new StreamReader(context.Request.Body))
                    {
                        ...
                        await context.Response.WriteAsync($"<h1>Parametros do http</h1>");
                ...
                //http://localhost:5053/query-string?danilo=teste&parceiro=daniel
                ...
                endpoints.MapGet("/pdf", async context => {
                    ...
                    gfx.DrawString("Hello, Word!", font, XBrushes.Black, new XRect(0, 0, page.Width, page.Height), XStringFormats.Center);
                    const string filename = "/Downloads/Helloword.pdf";
